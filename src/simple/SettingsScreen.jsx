    ...
    <section>
      ...
      {panel === "account" && (
        <div className="card">
          ...
          {subscription?.status === "active" && <p>{subscription.plan || "Plan"} is marked active.</p>}
          {missing.length > 0 && <p>{missing.length} items still need a supplier.</p>}
          <p>Recipes, invoices, waste, insights, team permissions, and the sales-rep tools are still in the classic app.</p>
          <div className="stack block">
            <a className="btn" href="/app?classic=1">Open classic MOE</a>
